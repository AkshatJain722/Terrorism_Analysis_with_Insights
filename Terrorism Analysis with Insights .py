...
def create_app_ui():
  ...
  html.Center([
          html.H1('Terrorism Analysis with Insights', id='Main_title',style={'color': '#123c69','font-weight': 'bold'})
          ]),
      ...
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map", children=[
          ...
          dcc.Dropdown(
              id='month', 
                ...
                style = {'backgroundColor':'#123c69','color':'grey'},
                multi = True
                  ),
          dcc.Dropdown(
                id='date', 
          ...
          dcc.Dropdown(
                id='country-dropdown', 
                options=[{'label': 'All', 'value': 'All','color':'white','backgroudColor':'black'}],
          ...
          html.Center([
                  html.H3('Select the Year', id='year_title',style = {'color':'#123c69','font-weight': 'bold'})
                  ]),
          dcc.RangeSlider(
                    id='year-slider',
                    min=min(year_list),
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
            ...
            dcc.Dropdown(id="Chart_Dropdown",
                         ...
                         value = "region_txt",
                         style = {'color':'grey','backgroundColor':'#123c69',"text-align":'center','font-weight': 'bold'}),
            html.Br(),
            html.Br(),
            html.Hr(),
            html.Center([
                        ...
                        style = {"text-align":'center','color':'grey','backgroundColor':'#123c69'})
                    ]),
            html.Hr(),
            html.Br(),
            html.Center([
                  html.H3('Select the Year', id='year_title1',style = {'color':'#123c69','font-weight': 'bold'})
                  ]),
            dcc.RangeSlider(
                    id='cyear_slider',
                    min=min(year_list),
  ...
  html.Center([
    html.H1(id="graph-object",children ="Graph will be shown here",style = {'color':'#123c69','font-weight': 'bold'})
         ]),          
  ])
